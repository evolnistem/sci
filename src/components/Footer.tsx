...
const Footer = () => {
  ...
  return <footer className="bg-science-dark text-white">
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="flex items-center text-xl font-serif font-semibold mb-6">
              <img src="/lovable-uploads/2d90386a-f3dc-41e7-8f0c-3de6e31813df.png" alt="SimpleScience Logo" className="h-8 mr-2" />
      ...
      <button onClick={scrollToTop} className="fixed bottom-6 right-6 p-3 bg-science-blue rounded-full shadow-lg hover:bg-science-teal transition-colors duration-300" aria-label="Scroll to top">
