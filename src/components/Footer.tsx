...
const Footer = () => {
  ...
  return (
    <footer className="bg-science-dark text-white">
      ...
      <button 
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 p-3 bg-science-blue rounded-full shadow-lg hover:bg-science-teal transition-colors duration-300"
